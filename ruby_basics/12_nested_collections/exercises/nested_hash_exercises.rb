def find_language_information(languages, language_name)
  ...
  # }
  # a = Hash.new()
  # a = languages.filter_map{|name, data| data if name == language_name}.compact
  # return a[0]
...
def find_beautiful_languages(languages)
  ...
  # languages.filter_map{|name, data| data if data[:is_beautiful?]==true}
  a = Hash.new()
  languages.each do |i, data|
...
def find_language_facts(languages, language_name, fact_index = 0)
  ...
  #                 is_beautiful?: false }
  # }
  a = languages.dig(language_name)
  if a==nil
    return nil
  end
  # if a[:facts][fact_index]
  #   return a[:facts][fact_index]
  # else
  #   nil
  # end
  x = a.dig(:facts)
